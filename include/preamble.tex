...
\pagestyle{plain}
\geometry{inner=30mm, outer=20mm, top=30mm, bottom=35mm}
...
\newcommand{\applyvariables}{
	...
	\hypersetup{
		...
		pdfproducer={\szerzoMeta},   % producer of the document (organization)
...
%--------------------------------------------------------------------------------------
\newcommand{\excludefromlocandtoc}{
