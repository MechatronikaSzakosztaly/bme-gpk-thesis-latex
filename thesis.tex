...
\newcommand{\gpkcim}{Gazdájához kötődő PID-szabályozó fejlesztése} %TODO Cím [Title]
\newcommand{\gpktanszek}{\bmemogi} %TODO Tanszék [Department]
% \bmeatt \bmeara \bmeenergia \bmeepget \bmegtharom \bmemanuf \bmehds \bmemogi \bmemm \bmept

%TODO SZAKDOLGOZAT esetén használandó blokk [Use this block for BACHELORS THESIS]
%--------------------------------------------------------------------------------------
\newcommand{\gpkmunkatipus}{\bsc}     % Dokumentum típusa [Document type]
\newcommand{\gpkmunkatipusok}{\bsck}  % többesszámban
\newcommand{\gpkmunkatipusHU}{\gpkmunkatipus}  % Dokumentum típusa HU [Document type]
\newcommand{\gpkmunkatipustHU}{\bsct}   % tárgyraggal
%--------------------------------------------------------------------------------------

%TODO DIPLOMATERV esetén használandó blokk [Use this block for BACHELORS THESIS]
%--------------------------------------------------------------------------------------
%\newcommand{\gpkmunkatipusHU}{\mscHU}  % Dokumentum típusa HU [Document type]
%\newcommand{\gpkmunkatipustHU}{\msctHU}% tárgyrakkal  
%\newcommand{\gpkmunkatipus}{\msc}      % Dokumentum típusa
%\newcommand{\gpkmunkatipusok}{\msck}   % többesszámban
%--------------------------------------------------------------------------------------
